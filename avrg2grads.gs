...
mdiv=5*div
if(aaa < alg5);mdiv=2*div;endif
if(aaa < alg2);mdiv=1*div;endif
say aaa','alg2','alg5','mdiv
...
"set strsiz 0.1 0.1"
*"draw string 2.7 6.1 +"
*"draw string 2.6 6. HsinDa PP"
"set strsiz 0.2 0.16"
*"draw string 2.2 10.5 "spnm" "spun" at "datep 
*"draw string 4.2 10.5 "spnm" "spun" at "datep 
"draw string 2.2 10.5 "spnm" "spun" at "datep 
"printim "datep SPEC".png x850 y1200 white"
*pull dummy
"c"
endif
i=i+1
